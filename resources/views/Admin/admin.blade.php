...
<body>
    ...
    <main>
        ...
        <!-- <div id="h2"><span>Welcome <br><br>Mr.{{auth()->user()->name}} Vous etes maintenant admin</span></div> -->
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Quantite</th>
                            <th>Description</th>
                            <th><a href="{{route('admin.create.resource',['type'=>'server'])}}" class="btn">Ajouter</a></th>
                        </tr>
                    </thead>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Quantite</th>
                            <th>Description</th>
                            <th><a href="{{route('admin.create.resource',['type'=>'vm'])}}" class="btn">Ajouter</a></th>
                        </tr>
                    </thead>
                    @foreach($resources as $resource)
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Quantite</th>
                            <th>Description</th>
                            <th><a href="{{route('admin.create.resource',['type'=>'network'])}}" class="btn">Ajouter</a></th>
                        </tr>
                    </thead>
                    @foreach($resources as $resource)
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Quantite</th>
                            <th>Description</th>
                            <th><a href="{{route('admin.create.resource',['type'=>'storage'])}}" class="btn">Ajouter</a></th>
                        </tr>
                    </thead>
                    @foreach($resources as $resource)
